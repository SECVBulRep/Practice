...
public class CompanyGenerator
{
    ...
    public async Task Generate(int count, AppDbContext context)
    {
        ...
        generatedRoles = (List<Role>)null;
        generatedUsers = (List<User>)null;
        generatedAuthors = (List<Author>)null;
        generatedpublishers = (List<Publisher>)null;
        generatedBooks = (List<Book>)null;
        db = (AppDbContext)null;
    }
