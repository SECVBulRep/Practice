...
""", _testCompany);
    ...
    [Benchmark()]
    public async Task<List<Company>> EF_Query_Filter()
    {
        var temp =await _companiesContext.Database.SqlQuery<Company>($"SELECT * FROM COMPANIES WHERE Name={_testCompany.Name}").ToListAsync();
